...
function populateMain(anobject) {
    i=0
    dictionary = {}
...
function toogleSideBar() {
    ...
    if (w === 0) {
        ...
        document.getElementById("doc-container").append(coyoteDance)
        coyoteDance.setAttribute("id", "coyoteDance")
        coyoteDance.setAttribute("class", "documentitem")
        document.getElementById('coyoteDance').append('Coyote at the Dance')
        let testDiv = document.createElement("div");
        document.getElementById("doc-container").append(testDiv)
        testDiv.setAttribute("id", "testDiv")
        testDiv.setAttribute("class", "documentitem")
        document.getElementById('testDiv').append('New Test')
    }
    else if (w===250) {
